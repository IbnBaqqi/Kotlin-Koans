 ...
 * Add the function compareTo to the class MyDate to make it comparable. After this, the code below date1 < date2 should start to compile.
 * Note that when you override a member in Kotlin, the override modifier is mandatory.
 */

package com.salausmart.Conventions
